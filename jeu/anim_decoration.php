...
<html>
    ...
    <style>
        body {
            /* On utilise le chemin absolu commençant par / */
            background-image: url('/public/img/backgrounds/tente_chancellerie.jpg') !important;
        ...
        /* Ta classe pour le container noir semi-transparent */
        .container-main {
        ...
        /* Style pour forcer le texte en blanc dans la table des décorations */
        .table-deco {
        ...
        <div class="container-main">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div align="center">
                        <h2>BUREAU CHANCELLERIE - Gestion des décorations des Unités</h2>
                ...
                <div class="col-12">
                    ...
                    if (isset($_POST['liste_perso_deco']) && $_POST['liste_perso_deco'] != "") {
                        ...
                        if ($nb_event) {
                            ...
                            echo "<center>";
                            echo "<table border=1 class='table table-deco'>";
                            echo "    <tr>";
                            ...
                            echo "<center><i style='color:white;'>Aucune décoration reçues</i></center>";
                        }
